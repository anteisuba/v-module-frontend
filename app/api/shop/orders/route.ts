...
function buildOrdersCsv(
  ...
  const rows = orders.map((order) => {
    ...
    return [
      ...
      escapeCsvField(order.paymentRoutingMode),
      escapeCsvField(order.payoutAccountId),
      escapeCsvField(order.connectedAccountId),
      escapeCsvField(order.externalChargeId),
      escapeCsvField(order.externalTransferId),
      escapeCsvField(order.totalAmount),
      escapeCsvField(order.platformFeeAmount),
      escapeCsvField(order.sellerGrossAmount),
      escapeCsvField(order.sellerNetExpectedAmount),
