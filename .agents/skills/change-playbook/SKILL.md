...
Use this playbook to implement repo changes with the correct local context. Read [`../../../AGENTS.md`](../../../AGENTS.md) first, then load the relevant local `AGENTS.md` before editing.
...
- Keep root `AGENTS.md` short and navigational.
