...
Review repository changes with the local risk model, not with a generic web-app checklist. Start from [`../../../CLAUDE.md`](../../../CLAUDE.md), then read the relevant local `CLAUDE.md` before judging a diff.
