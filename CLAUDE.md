...
- `docs/`: 正式长文档层
- `.claude/skills/`: 可复用 AI 工作模式
- `.claude/hooks/`: 当前仓库的 guardrail 说明和验证矩阵
...
- 技能：[`review-checklist`](./.claude/skills/review-checklist/SKILL.md)、[`change-playbook`](./.claude/skills/change-playbook/SKILL.md)
